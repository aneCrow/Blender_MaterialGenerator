...
# last modification: 2019-09-12
#  -- add custom-preferences panel -- Emanuel Rumpf --
...
def _update_panel_fnc(self, context):
    ...
    main_panel.bl_category = addon.preferences.tab_label
...
class OBJECT_PT_my_panel (Panel):
    ...
    bl_region_type = "UI"
    # note: replaced by preferences-setting in register function
    bl_category = "Tool"
...
#       bl_category = bpy.context.preferences.addons[__name__].
